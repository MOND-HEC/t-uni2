...
format:
  html:
    ...
    output-file: regeneracion_fresa
    theme: cerulean
editor_options:
...
La fresa (*Fragaria × ananassa*) es una planta perenne de la familia Rosaceae, que ha ganado importancia económica y nutricional a nivel mundial. En Perú, la variedad San Andreas se destaca por su calidad superior y resistencia, siendo demandada en los mercados internacionales (Mixquititla-Casbis et al., 2020). Sin embargo, los cultivos de fresa enfrentan desafíos fitopatológicos, como el moho gris causado por *Botrytis cinerea*, que afecta la producción (Cho et al., 2014). Este patógeno provoca descomposición acelerada de los frutos, lo que reduce la calidad (Chulanov et al., 2021).

La biotecnología vegetal ha emergido como una herramienta clave para superar estos desafíos, permitiendo el mejoramiento genético rápido y eficiente de cultivos, sin la necesidad de cruzamientos convencionales (Gaston et al., 2020). Las técnicas de ingeniería genética y edición genética, como CRISPR/Cas9, se han utilizado para mejorar la resistencia de plantas a enfermedades (Koloniuk et al., 2022). Además, los métodos de regeneración de protoplastos en fresa abren nuevas posibilidades para el mejoramiento genético, facilitando la creación de cultivos más resistentes y competitivos (Vieira et al., 1990).

# OBJETIVOS

## Objetivo general

Determinar un protocolo adecuado para la regeneración de plantas de fresa (*Fragaria × ananassa*) en la variedad San Andreas a partir de protoplastos.

## Objetivos específicos

- Validar un método para la inducción de brotes a partir de pecíolos de fresa mediante diferentes concentraciones de reguladores de crecimiento.
- Optimizar el aislamiento de protoplastos a partir de hojas de fresa mediante diferentes concentraciones de soluciones enzimáticas.
- Regenerar plantas completas a partir de protoplastos aislados de hojas de fresa mediante diferentes concentraciones de reguladores de crecimiento.

# ANTECEDENTES DE LA INVESTIGACIÓN

La fresa (Fragaria × ananassa) es una planta perenne que pertenece a la familia Rosaceae y ha ganado una importancia económica y nutricional considerable a nivel global. Su capacidad de adaptarse a diversas condiciones climáticas le ha permitido ser cultivada ampliamente en diferentes regiones, destacando especialmente en las áreas andinas de Perú (Rivas et al., 2023). Dentro de las variedades más relevantes en el país se encuentra la variedad San Andreas, reconocida por su resistencia y calidad superior, lo que la convierte en una de las más demandadas en los mercados internacionales (Mixquititla-Casbis et al., 2020). A medida que la producción de fresa en el Perú ha incrementado, se ha convertido en una actividad agrícola clave para las regiones de Cañete, Barranca,  Huaral y ahora Amazonas, donde las condiciones climáticas favorecen el cultivo de esta planta (Quispe et al., 2025). Sin embargo, el crecimiento de esta industria también enfrenta varios desafíos relacionados con la aparición de enfermedades fitopatológicas que afectan la producción (Somssich, 2004).

Uno de los principales problemas que enfrenta el cultivo de fresa es el moho gris, una enfermedad causada por el hongo Botrytis cinerea (Cho et al., 2014). Este patógeno afecta principalmente los frutos, causando una descomposición acelerada que reduce la calidad de los frutos (Chulanov et al., 2021). La rápida propagación del hongo representa un desafío significativo para los productores, quienes recurren con frecuencia al uso de fungicidas químicos para tratar de mitigar sus efectos (Dean et al., 2012). Sin embargo, el uso excesivo de estos tratamientos plantea preocupaciones tanto en términos de seguridad alimentaria como de impacto ambiental, lo que resalta la necesidad urgente de encontrar soluciones más sostenibles para el control de esta enfermedad (Fitzgerald et al, 2008).
...
**Multiplicación de Pecíolos:** Se utilizarán 120 pecíolos de fresa distribuidos en 12 tratamientos con 10 pecíolos por placa en cada tratamiento, con el fin de evaluar el número de brotes por planta.

**Aislamiento de Protoplastos:** Se emplearán 20 hojas de fresa, con tratamientos de celulosa y macerozima para determinar la cantidad de protoplastos viables por hoja.

**Regeneración de Plantas:** Se evaluará el porcentaje de plantas regeneradas a partir de protoplastos aislados de hojas de fresa, utilizando diferentes concentraciones de reguladores de crecimiento.
...
•	Concentración de Benzilaminopurina (BAP): Se evaluarán diferentes concentraciones de Benzilaminopurina (BAP) en combinación con 2,4-D (0,1 mg/L, 0,5 mg/L, 1 mg/L), incluyendo una concentración de 0 mg/L como control.

•	 Concentración de Ácido 2,4-diclorofenoxiacético (2,4-D): Se evaluarán diferentes concentraciones de 2,4-D combinadas con BAP para determinar las condiciones óptimas para la inducción de brotes. Las concentraciones de 2,4-D serán de 0,1 mg/L, 0,5 mg/L y 1,0 mg/L, combinadas con concentraciones de BAP que varían entre 0,1 mg/L y 1,0 mg/L, incluyendo una concentración de 0 mg/L en ambos reguladores como control.

-Etapa de Aislamiento de Protoplastos (Objetivo 2):

•	Concentración de Celulasa: Se utilizarán diferentes concentraciones de celulasa para la digestión enzimática de los tejidos, específicamente 0%, 0,5%, 1%, 1,5% y 2%, con el fin de determinar la concentración óptima para el aislamiento de protoplastos.
•	Concentración de Macerozima: Se emplearán diferentes concentraciones de macerozima (0%, 0,05%, 0,1%) para la disolución de la pared celular.

-Etapa de Regeneración de Protoplastos (Objetivo 3):

•	Concentración de BAP: Se evaluarán diferentes concentraciones de BAP (0 mg/L, 3 mg/L, 5 mg/L, 7 mg/L) en combinación con Thidiazuron (TDZ) y Ácido naftalenoacético (NAA) para determinar las condiciones óptimas para la regeneración de plantas completas a partir de protoplastos.
•	Concentración de TDZ y NAA: Se evaluarán diferentes concentraciones de TDZ (0 mg/L, 3 mg/L, 5 mg/L) y NAA (0,1 mg/L, 0,2 mg/L) para determinar las condiciones óptimas para la regeneración de plantas completas.


### Variables dependientes

-Número de Brotes por Planta: Se evaluará la cantidad de brotes generados a partir de pecíolos tratados con diferentes concentraciones de reguladores de crecimiento. Esta variable se utilizará para determinar la eficiencia de los tratamientos en la inducción de brotes y su capacidad para estimular el crecimiento in vitro.

-Número de Protoplastos Aislados: Se cuantificará la cantidad de protoplastos viables obtenidos de las hojas de fresa mediante la aplicación de soluciones enzimáticas, que incluyen celulasa y macerozima. Esta variable es crucial para evaluar la eficacia del proceso de aislamiento de protoplastos y la viabilidad celular necesaria para las etapas subsecuentes de regeneración.

-Regeneración de Plantas: La regeneración exitosa de plantas a partir de protoplastos se evaluará mediante las siguientes subvariables:

•	Viabilidad de los Protoplastos: Se analizará la capacidad de los protoplastos para sobrevivir y dividirse después del proceso de aislamiento. La viabilidad es un factor determinante para asegurar que los protoplastos puedan progresar a las etapas de regeneración.

•	Formación de Microcolonias: Se evaluará la formación de microcolonias como indicador de la división celular exitosa, que constituye el primer paso hacia la regeneración de plantas completas. La formación de estas microcolonias es esencial para la posterior organogénesis.

•	Tasa de Regeneración: Se calculará el porcentaje de protoplastos que, tras su aislamiento y cultivo, logran regenerar plantas completas bajo las condiciones experimentales establecidas. Esta tasa será fundamental para determinar la eficiencia de los protocolos de regeneración y la capacidad de los protoplastos para dar lugar a plantas viables y completas.
...
El material de estudio consistirá en estolones y yemas axilares de la variedad de fresa San Andreas (Fragaria × ananassa), obtenidos del Instituto Nacional de Innovación Agraria (Estación Experimental Agraria Donoso). Inicialmente, se realizará un cultivo in vitro de estas plantas en medio MS estándar, el cual garantizará su desarrollo en condiciones controladas y libres de enfermedades. Una vez establecidas, se utilizarán los pecíolos para la multiplicación de brotes, empleando diferentes concentraciones de reguladores de crecimiento para inducir la formación de nuevos brotes. 
Las hojas de las plantas cultivadas se utilizarán para el aislamiento de protoplastos, mediante la aplicación de soluciones enzimáticas como celulasa y macerozima, con el fin de obtener células viables para su regeneración. Finalmente, los protoplastos aislados se cultivarán en medios específicos para evaluar su capacidad de regenerar plantas completas en condiciones controladas, asegurando una producción libre de patógenos y apta para el mejoramiento genético.

## Diseño de la investigación

-Etapa de multiplicación:

En esta investigación se utilizará un diseño completamente al azar (DCA) con arreglo factorial, donde el factor A representa las concentraciones de BAP y el factor B las concentraciones de 2,4-D. Estará compuesto por 12 tratamientos y 6 repeticiones, donde cada unidad experimental consistirá en una placa de cultivo con 10 pecíolos por tratamiento.

-Para la fase de aislamiento de protoplasto:

Se utilizará un diseño experimental completamente al azar (DCA) con arreglo factorial, donde el Factor A representa las concentraciones de Celulasa y el Factor B las concentraciones de Macerozima. El experimento constará de 5 tratamientos y 3 repeticiones, donde cada unidad experimental consistirá en 20 hojas de fresa por tratamiento.

-Regeneración de protoplastos:

Se utilizará un diseño experimental completamente al azar (DCA) con arreglo factorial, donde el Factor A representará las concentraciones de BAP (Benzilaminopurina), el Factor B las concentraciones de 2,4-D (Ácido 2,4-diclorofenoxiacético), y el Factor C las concentraciones de NAA (Ácido naftalenoacético). El experimento constará de 8 tratamientos y 6 repeticiones, donde cada unidad experimental consistirá en una placa de cultivo con 5 microcallos por tratamiento.
